...
class res_config_settings(models.TransientModel):
    ...
    sales_forecast_method = fields.Selection(forecast_method_selection, string="Sales Forecast method")
    sales_forecast_interval = fields.Selection(interval_selection, string="Sales Data Series Interval")
    sales_predicted_periods = fields.Integer(string="Sales Number of predicted periods")
